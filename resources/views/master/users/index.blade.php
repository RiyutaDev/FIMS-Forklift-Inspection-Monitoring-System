            ...
            <div class="card-body">
                <form action="{{ route('master.users.index') }}" method="GET">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 mb-3">
                            <label for="role_id" class="text-sm">
                                Hak Akses (Role)
                            </label>
                        ...
                        <div class="col-md-3 col-sm-6 mb-3">
                            <label for="location_id" class="text-sm">
                                Area Kerja
                            </label>
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            ...
                            <a
                                ...
                                class="btn btn-default btn-sm px-3 ml-2"
                            >
                            ...
                            @forelse ($users as $index => $user)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        {{-- DETAIL --}}
                                        <a
                                            href="{{ route('master.users.show', $user->id) }}"
                            ...
                            @empty
                                ...
                                <tr>
                                    ...
                                    >
                                        ...
                                        <p class="text-sm">
                                            Silakan ubah kriteria pencarian
    ...
    */
    ...
    deleteUserForms.forEach(function (form) {
        ...
        form.addEventListener('submit', function (event) {
            ...
            const employeeNumber = form.dataset.employeeNumber;
                    ...
                    */
                    ...
                    Swal.fire({
                        ...
                        html: `
                            <div class="mt-2">
                                <span>
                                    Mohon tunggu, sistem sedang menghapus
                                    data pengguna.
                                </span>
                            </div>
                        `,
